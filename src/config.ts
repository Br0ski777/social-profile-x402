  ...
  routes: [
    {
      ...
      toolDescription: "Use this when you need public profile data from a social media handle or URL. Supports Twitter/X, GitHub, LinkedIn, and YouTube. Returns: display name, bio, avatar URL, follower count, following count, post count, location, website, account creation date, verification status. Do NOT use for email lookup — use email_find_by_name instead. Ideal for influencer research, lead enrichment, social listening.",
      inputSchema: {
        type: "object",
        properties: {
